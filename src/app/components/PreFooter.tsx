...
function PreFooter() {
    return (
        <header className='mt-20 flex border-b py-4 px-4 sm:px-10 bg-[#FAFAFA] font-sans min-h-[70px] tracking-wide relative z-50 h-[8.5rem]'>
            <div className='flex flex-wrap items-center lg:gap-y-2 gap-y-4 gap-x-4 w-full max-w-[65.5rem] mx-auto'>
                <div className="left">
